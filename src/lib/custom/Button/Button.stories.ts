...
const meta = {
  ...
  argTypes: {
    ...
    variant: {
      control: 'select',
      options: ['primary', 'secondary', 'danger', 'success', 'ghost', 'outline', 'gradient-primary', 'gradient-secondary', 'gradient-purple-blue', 'gradient-emerald-teal', 'gradient-orange-pink']
    },
    size: {
      control: 'select',
      options: ['sm', 'md', 'lg']
