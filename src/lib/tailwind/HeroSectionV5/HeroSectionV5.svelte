...
<style>
  ...
  .hero__mockup-perspective {
    transform: perspective(6000px) rotateY(28deg);
    transform-origin: left top;
    filter: drop-shadow(0 40px 120px rgba(0, 0, 0, 0.85))
            drop-shadow(0 0 100px rgba(0, 212, 170, 0.06));
    flex-shrink: 0;
  }
  ...
  .hero__mockup {
    display: flex;
    /* perspective(6000px) rotateY(28deg): apparent width ≈ actual × cos(28°) ≈ actual × 0.883.
       At 1400px: apparent ≈ 1236px. Fills the right side; section overflow:hidden clips cleanly. */
    width: 1400px;
    height: 680px;
