...
<section class="hero-section px-6">
  ...
  <div class="max-w-7xl mx-auto hero-split">
    <div class="hero-text">
    ...
    <div class="hero-visual" aria-hidden="true">
      <div class="hero-diagram-panel">
        <div class="hero-diagram-header">
          <span class="hero-diagram-title">Agent Architecture</span>
          <span class="hero-diagram-badge"><span class="hero-diagram-dot"></span>Live</span>
        </div>
        <svg class="hero-arch-svg" viewBox="0 0 480 360" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="svc-dotgrid" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
              <circle cx="1" cy="1" r="0.8" fill="rgba(255,255,255,0.04)" />
            </pattern>
            <marker id="svc-arrow" markerWidth="6" markerHeight="4" refX="6" refY="2" orient="auto">
              <polygon points="0 0, 6 2, 0 4" fill="rgba(0,212,170,0.6)" />
            </marker>
          </defs>
          <rect width="480" height="360" fill="#0d0d14" />
          <rect width="480" height="360" fill="url(#svc-dotgrid)" />
          <!-- USER node -->
          <rect x="20" y="155" width="70" height="36" rx="8" fill="#0d0d14" stroke="rgba(0,212,170,0.3)" stroke-width="1" />
          <text x="55" y="170" text-anchor="middle" fill="#e2e8f0" font-family="ui-monospace,monospace" font-size="9" font-weight="600">USER</text>
          <text x="55" y="182" text-anchor="middle" fill="#64748b" font-family="ui-monospace,monospace" font-size="7">input</text>
          <!-- USER → ORCHESTRATOR -->
          <line x1="90" y1="173" x2="148" y2="163" stroke="#00d4aa" stroke-width="1" stroke-dasharray="4 3" opacity="0.55" marker-end="url(#svc-arrow)" />
          <!-- ORCHESTRATOR node -->
          ...
          <line x1="260" y1="168" x2="308" y2="201" stroke="#00d4aa" stroke-width="1" stroke-dasharray="4 3" opacity="0.5" marker-end="url(#svc-arrow)" />
          ...
          <line x1="400" y1="201" x2="423" y2="188" stroke="#00d4aa" stroke-width="1" stroke-dasharray="3 3" opacity="0.4" marker-end="url(#svc-arrow)" />
          <line x1="400" y1="266" x2="423" y2="253" stroke="#00d4aa" stroke-width="1" stroke-dasharray="3 3" opacity="0.4" marker-end="url(#svc-arrow)" />
          <!-- VDB -->
          <rect x="425" y="45" width="40" height="26" rx="5" fill="#0d0d14" stroke="rgba(0,212,170,0.18)" stroke-width="1" />
          <text x="445" y="56" text-anchor="middle" fill="#64748b" font-family="ui-monospace,monospace" font-size="7.5" font-weight="600">VDB</text>
          ...
          <text x="445" y="195" text-anchor="middle" fill="#334155" font-family="ui-monospace,monospace" font-size="6">model</text>
          <!-- Cache -->
          <rect x="425" y="240" width="40" height="26" rx="5" fill="#0d0d14" stroke="rgba(0,212,170,0.18)" stroke-width="1" />
          <text x="445" y="251" text-anchor="middle" fill="#64748b" font-family="ui-monospace,monospace" font-size="7.5" font-weight="600">Cache</text>
          <text x="445" y="260" text-anchor="middle" fill="#334155" font-family="ui-monospace,monospace" font-size="6">redis</text>
          <!-- Legend -->
          <line x1="20" y1="330" x2="44" y2="330" stroke="#00d4aa" stroke-width="1" stroke-dasharray="4 3" opacity="0.5" />
          <text x="48" y="334" fill="#334155" font-family="ui-monospace,monospace" font-size="7">Data flow</text>
          <rect x="110" y="324" width="18" height="12" rx="3" fill="#0d0d14" stroke="rgba(0,212,170,0.22)" stroke-width="1" />
          <text x="132" y="334" fill="#334155" font-family="ui-monospace,monospace" font-size="7">Agent node</text>
          <rect x="205" y="324" width="18" height="12" rx="3" fill="#111117" stroke="#00d4aa" stroke-width="1.5" />
          <text x="227" y="334" fill="#334155" font-family="ui-monospace,monospace" font-size="7">Orchestration</text>
        </svg>
        <div class="hero-diagram-footer">
          <span class="hero-diagram-footer-dot"></span>
          <span class="hero-diagram-footer-text">4 agents active · 12ms avg latency</span>
        </div>
      </div>
    </div>
  </div>
...
<!-- ============================================================
     5b. CUSTOM DEVELOPMENT
     ============================================================ -->
<section class="section-custom-dev px-6" id="custom-development">
  <div class="max-w-7xl mx-auto">
    <div class="custom-dev-inner">
      <div class="custom-dev-glow" aria-hidden="true"></div>
      <div class="section-header custom-dev-header">
        <div class="section-label">CUSTOM DEVELOPMENT</div>
        <p class="custom-dev-intro">
          We also build the fullstack and UI around your AI systems. APIs, databases, dashboards, and interfaces when you need them.
        </p>
      </div>

      <div class="custom-dev-grid">
        <div class="custom-dev-card custom-dev-card--fullstack">
          <div class="custom-dev-card-icon">
            <svg width="24" height="24" fill="none" stroke="#00d4aa" stroke-width="1.5" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"/>
            </svg>
          </div>
          <h3 class="custom-dev-card-title">Backend and APIs</h3>
          <p class="custom-dev-card-desc">
            APIs, databases, and integrations that power your AI systems. Node, Python, TypeScript.
          </p>
        </div>

        <div class="custom-dev-card custom-dev-card--ui">
          <div class="custom-dev-card-icon">
            <svg width="24" height="24" fill="none" stroke="#00d4aa" stroke-width="1.5" viewBox="0 0 24 24">
        ...
        <div class="custom-dev-card custom-dev-card--bridge">
          <div class="custom-dev-card-icon">
            <svg width="24" height="24" fill="none" stroke="#00d4aa" stroke-width="1.5" viewBox="0 0 24 24">
...
<style>
  ...
  @media (min-width: 1024px) {
    .section-custom-dev { padding: 4rem 0; }
  }
  ...
  .custom-dev-glow {
    ...
    width: 280px;
    height: 280px;
    background: radial-gradient(circle at center, rgba(0, 212, 170, 0.05) 0%, transparent 65%);
    pointer-events: none;
  }
